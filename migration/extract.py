...
def to_sql(data: dict, generated_at: str) -> str:
    ...
    parts = ["-- Generated by migration/extract.py. Do not edit by hand.",
             ...
             "-- Destructive reset: apply all schema migrations before loading this seed.",
             "DELETE FROM import_issue_links;", "DELETE FROM import_rows;", "DELETE FROM import_files;", "DELETE FROM import_jobs;",
             "DELETE FROM issues;", "DELETE FROM import_issues;", "DELETE FROM reservations;",
             "DELETE FROM reservation_import_keys;",
